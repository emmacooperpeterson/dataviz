...
hti <- summarise(group_by(hti, country), prosecutions = sum(prosnum))
...
ggplot(combined, aes(x=hdi_score, y=ht_index)) +
  geom_jitter(aes(color=region, size=prosecutions)) +
...
labs(y = "Human Trafficking Index (15 = best score)", x = "Human Development Index (1=best score)", 
  ...
  theme(panel.grid.minor.x=element_blank(),
        ...
        plot.subtitle = element_text(family="Courier New", margin=margin(b=10)),
